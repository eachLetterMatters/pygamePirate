...
class Level:
	def __init__(self, tmx_map, level_frames, data):
		...
		self.semi_collision_sprites = pygame.sprite.Group() 	# collides only with players bottom
	...
	def setup(self, tmx_map, level_frames):
		...
		for obj in tmx_map.get_layer_by_name('Objects'):
			if obj.name == 'player':
				...
				if obj.name in ('barrel', 'crate'):		# not animated sprites
	...
	def item_collision(self):
		if self.item_sprites:
			# all items collided with will be removed from item_sprites and returned to variable
